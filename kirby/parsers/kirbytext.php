...
class kirbytext {
  ...
  static function youtube($params) {
    ...
    return '<div class="video"><iframe' . $class . ' width="' . $params['width'] . '" height="' . $params['height'] . '" src="' . $url . '" frameborder="0" allowfullscreen></iframe></div>';
  ...
  static function vimeo($params) {
    ...
    return '<div class="video"><iframe' . $class . ' src="' . $url . '?byline=0&amp;portrait=0&amp;badge=0&amp;color=ffffff" width="' . $params['width'] . '" height="' . $params['height'] . '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>';
